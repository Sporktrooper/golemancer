...
// set up buttons
buttons[0].addEventListener('click',function(){buttons[0].effect()})
  
  document.addEventListener('keydown', (e) => {
    if (e.keyCode == (65) && !inputReceived) {
//      inputReceived = true;
      buttons[0].effect();
...
buttons[1].addEventListener('click',function(){buttons[1].effect()})
  
  document.addEventListener('keydown', (e) => {
    if (e.keyCode == (83) && !inputReceived) {
//      inputReceived = true;
      buttons[1].effect();
...
buttons[2].addEventListener('click',function(){buttons[2].effect()})
  
  document.addEventListener('keydown', (e) => {
    if (e.keyCode == (38) && !inputReceived) {
//      inputReceived = true;
      buttons[2].effect();
...
buttons[3].addEventListener('click',function(){buttons[3].effect()})
  
  document.addEventListener('keydown', (e) => {
    if (e.keyCode == (39) && !inputReceived) {
//      inputReceived = true;
      buttons[3].effect();
